...
import { amountFromInput, amountStep, amountToInput, copy, foodName, foodSubtitle, priceLabel, SPEND_MAX, SPEND_MIN, type Language } from '@/lib/i18n';
...
export default function Home(){
 ...
 const [budget,setBudget]=useState('50'),[custom,setCustom]=useState(()=>amountToInput(50,readLanguage())),[veg,setVeg]=useState(false),[sound,setSound]=useState(true),[spinning,setSpinning]=useState(false),[result,setResult]=useState<Food|null>(null),[revealed,setRevealed]=useState(false);
 ...
 {preferences.ready&&population.length>0&&!eligible.length&&<p className="preferences-message">{t.vegEmpty}</p>}
